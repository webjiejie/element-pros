<template>
    <div class="main">
        <copyComponent shelter :code="code">
            <div slot="title">slot展示</div>
            <div class="main-t">
                <el-layout-pro :hearderProps="hearderProps" :menuList="menuList" :routerBase="routerBase">
                    <div slot="headerLeft">
                        hearder左边的渲染
                    </div>
                    ...
                    <div style="text-align: center;">中间布局</div>
                </el-layout-pro>
            </div>
        </copyComponent>
    </div>
...
export default {
    ...
    data(){
        return {
            ...
            hearderProps:{
                name:'测试',
                avatar:'https://cyj.lovewenqin.cn/static/favicon.ico',
                title:"elementPros",
                image:{
